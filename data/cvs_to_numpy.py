...
#'''Add haarcascade eye file should be added to get here '''
#CASC_PATH = '/home/jalaj/Downloads/emotion-recognition-neural-networks-master/haarcascade_files/haarcascade_eye.xml'
#CASC_PATH =='/home/jalaj/Downloads/emotion-recognition-neural-networks-master/haarcascade_files/haarcascade_frontalface_default.xml'
...
def format_image(image):
  ...
  gray_border[(int(150 / 2) - int(SIZE_FACE / 2)):(int(150 / 2) + int(SIZE_FACE / 2)),
  (int(150 / 2) - int(SIZE_FACE / 2)):(int(150 / 2) + int(SIZE_FACE / 2))] = image
  image = gray_border
